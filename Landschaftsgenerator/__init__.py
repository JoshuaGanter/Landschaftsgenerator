...
class CreateLandscape(bpy.types.Operator) :
    ...
    def invoke(self, context, event) :
        ...
        mesh = bpy.data.meshes.new(name="NewObject")
...
class AddonProperties(PropertyGroup):
    ...
    steepness_threshold = FloatProperty(
        ...
        description = "Threshold for the steepness layer",
        default = 45,
        update = update_steepness_l
        )
    ...
    texture_scaling = FloatProperty(
        ...
        description = "Scaling for the Textures",
        default = 200,
...
def register() :
    ...
    bpy.types.Scene.properties = PointerProperty(type=AddonProperties)
